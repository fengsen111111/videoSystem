        ...
        <div class="bg-cover w-screen img_bg">
            ...
            <div class="fixed bottom-4 flex px-28 h-16 w-full">
                ...
                <div class="w-1/3 flex justify-around text-white text-center">
                    <router-link to="/">
                        <div class="text-xl w-36 py-4" :class="rou_index==1?'img_demo_index':'img_demo'" @click="cliIndex(1)">首页</div>
                    </router-link>
                    <router-link to="/video">
                        <div class="text-xl w-36 py-4" :class="rou_index==2?'img_demo_index':'img_demo'" @click="cliIndex(2)">视频监控</div>
                    </router-link>
                    <router-link to="/system">
                        <div class="text-xl w-36 py-4" :class="rou_index==3?'img_demo_index':'img_demo'" @click="cliIndex(3)">设备状况</div>
                    </router-link>
                </div>
